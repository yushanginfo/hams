...
[@b.toolbar title="伙食费设置"]bar.addBack();[/@]
  [@b.form action=b.rest.save(walletSetting) theme="list"]
    ...
    [@b.textfield check="match('number')" name="walletSetting.warningChangeBalance" label="零用金低于多少时进行提醒" value=walletSetting.warningChangeBalance! required="true" comment="元"/]
    [@b.formfoot]
