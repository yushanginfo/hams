...
<div class="container-fluid text-sm">
  <h6 style="text-align: center;">上海民政第二精神卫生中心<br>${yearMonth?string('yyyy')}年度${walletType.name}病区汇总表</h6>
  <div class="row">
  ...
  [@b.grid items=walletStats?sort_by(["inpatient","bedNo"]) var="stat" style="border:0.5px solid #006CB2" sortable="false"]
    [@b.row]
