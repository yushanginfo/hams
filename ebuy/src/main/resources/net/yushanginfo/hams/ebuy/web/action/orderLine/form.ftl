...
[@b.toolbar title="随心E购买明细"]bar.addBack();[/@]
  [@b.form action=b.rest.save(orderLine) theme="list"]
    ...
    [@b.textfield name="orderLine.amount" label="数量" value= orderLine.amount required="true"/]
    [@b.textfield name="orderLine.price" label="单价" value= orderLine.price! required="true"/]
