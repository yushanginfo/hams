...
<div class="container-fluid text-sm">
  <h6 style="text-align: center;">上海民政第二精神卫生中心<br>${yearMonth?string('yyyy')}年度养护补贴病区汇总表</h6>
  <div class="row">
  ...
  [@b.grid items=stats var="stat" style="border:0.5px solid #006CB2" sortable="false"]
    [@b.row]
     [@b.col property="account.inpatient.code" title="住院号"/]
     [@b.col property="account.inpatient.bedNo" title="床号"/]
