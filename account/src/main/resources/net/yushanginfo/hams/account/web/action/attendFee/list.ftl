[#ftl]
[@b.head/]
[@b.grid items=attendFees var="attendFee"]
  [@b.gridbar]
    ...
    bar.addItem("${b.text("action.export")}",action.exportData("inpatient.code:住院号,inpatient.name:姓名,"+
                 ...
                 "balance:余额",null,'fileName=陪护费余额信息'));
  [/@]
  [@b.row]
    [@b.boxcol /]
    [@b.col width="10%" property="inpatient.code" title="住院号"]${attendFee.inpatient.code}[/@]
    [@b.col property="inpatient.name" title="姓名"]
      [@b.a href="!info?id=${attendFee.id}"]
        ${attendFee.inpatient.name}
      [/@]
    [/@]
    ...
    [@b.col width="10%" property="inpatient.beginAt" title="住院日期"]${attendFee.inpatient.beginAt?string("yyyy-MM-dd")}[/@]
