...
[@b.grid items=staffs var="staff"]
  ...
  [@b.row]
    ...
    [@b.col width="8%" property="status.name" title="在职状态"/]
    [@b.col width="10%" property="formalHr" title="是否在编"/]
    [@b.col width="10%" property="beginOn" title="在院时间"]${staff.beginOn?string('yyyy-MM')}~${(staff.endOn?string('yyyy-MM'))!'至今'}[/@]
  [/@]
[/@]
[@b.foot/]
