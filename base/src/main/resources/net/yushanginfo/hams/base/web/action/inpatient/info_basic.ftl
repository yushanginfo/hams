...
[#assign contact = inpatient.contact/]
  ...
  <table class="infoTable" align="center" width="100%">
    ...
    <tr>
      <td class="title">请假信息：</td>
      <td colspan="5">[#if inpatient.leaveAt??]${inpatient.leaveAt?string('yyyy-MM-dd HH:mm:ss')!} ~ ${(inpatient.backAt?string('yyyy-MM-dd HH:mm:ss'))!}[#else]无请假信息[/#if]</td>
    </tr>
  </table>
