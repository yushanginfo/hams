...
/**
 * <p>sysSynchroGetOrgBaseInfoContextV2 complex type的 Java 类。
 *
 * <p>以下模式片段指定包含在此类中的预期内容。
 *
 * <pre>
 * &lt;complexType name="sysSynchroGetOrgBaseInfoContextV2"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://out.webservice.organization.sys.kmss.landray.com/}sysSynchroGetOrgBaseInfoContext"&gt;
 *       &lt;sequence&gt;
...
@XmlType(name = "sysSynchroGetOrgBaseInfoContextV2", propOrder = {
    "extendPara",
    "isBusiness"
})
public class SysSynchroGetOrgBaseInfoContextV2
    extends SysSynchroGetOrgBaseInfoContext
{
